 ...
 * LeadImport
 *
 * Three-step CSV import wizard for leads.
...
export default function LeadImport({ fields, preview }) {
    return (
        <>
            ...
            <div className="space-y-6 max-w-3xl">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-0.5">
                        Upload a CSV file to bulk-import leads into the CRM.
                    </p>
                </div>
...
LeadImport.layout = (page) => <AppLayout>{page}</AppLayout>;
